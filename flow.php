...
<div class="flow__step flex">
    ...
    <div class="step__desc">
        ...
        <p>ご希望のサイズ、デザインの方向性を入力（参考サイトのURLでも可）し、<br class="pc">バナー制作に必要な写真素材やロゴを添付してください。</p>
    </div><!-- ./step__desc -->
</div>
<!-- ./flow__step -->
...
<div class="flow__step flex">
      ...
      <div class="step__desc">
        ...
        <p class="note">ご注意/免責事項<br>納品後の弊社による政策上の不具合は無性にて修正対応いたします。<br class="pc">それ以外の修正については新規のご依頼となります</p>
    </div><!-- ./step__desc -->
