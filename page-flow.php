...
<div class="flow__step flex">
    <div class="thumb">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/flow/step_thumb01.jpg?0408" alt="サムネイル">
    </div><!-- ./thumb -->

    <div class="step__desc">
        <span>STEP1</span>
        <h3>ご注文フォーム入力</h3>
        <p>ご希望のバナーサイズやオプションを入力するとお見積りが算出されますので、<br>カートに入れてお支払いへお進みください。</p><p class="note">※複数ご依頼いただく際は、同じ手順を繰り返してカートへ入れた上で<br class="pc">お支払いにお進みください。</p>
    </div><!-- ./step__desc -->
</div>
<!-- ./flow__step -->
...
<div class="flow__step flex">
      ...
      <div class="step__desc">
        <span>STEP2</span>
        <h3>デザインの指示・ファイルアップロード</h3>
        <p>ご注文フォーム入力の途中で『デザインの指示・ファイルアップロード』のエリアがあるので、そちらにて制作に必要な素材のアップロード、デザインのご指示・掲載する文章をご入力ください。<br>詳細にご指示を作成していただくことで、<br class="pc">より理想に近い仕上がりになります。<!-- <br>その際、指示書ジェネレーターをお使いいただくと便利ですが、エクセルやパワーポイントやPDFファイルなど、作成しやすいファイル形態で作成し、<br class="pc">マイページより添付してお送りください。 --></p>

    </div><!-- ./step__desc -->

       <div class="thumb">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/flow/step_thumb06.jpg?0408" alt="サムネイル">
    </div><!-- ./thumb -->
...
<div class="flow__step flex">
   <div class="thumb">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/flow/step_thumb02.jpg?0408" alt="サムネイル">
    </div><!-- ./thumb -->
      <div class="step__desc">
        <span>STEP3</span>
        <h3>お客様情報の入力</h3>
...
<div class="flow__step flex">
      ...
      <div class="thumb">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/flow/step_thumb03.jpg?0408" alt="サムネイル">
    </div><!-- ./thumb -->
...
<div class="flow__step flex">
  <div class="thumb">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/flow/step_thumb04.jpg?0408" alt="サムネイル">
    </div><!-- ./thumb -->
      <div class="step__desc">
        <span>STEP5</span>
        <h3>バナー制作開始</h3>
...
<div class="flow__step flex">
  ...
  <div class="thumb">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/flow/step_thumb05.jpg?0408" alt="サムネイル">
      </div><!-- ./thumb -->
</div>
<!-- ./flow__step -->
