        ...
        <dd class="flex">
            ...
            <div class="desc__contents">
                ...
                <div class="desc__wrap flex">
                    <div class="thumb">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_thumb01.png" alt="サムネイル">
                    </div>
                 ...
                 <div class="desc__wrap flex">
                    <div class="thumb">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_thumb02.png" alt="サムネイル">
                    </div>
                 ...
                 <div class="desc__wrap flex">
                    <div class="thumb">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_thumb03.png" alt="サムネイル">
                    </div>
                ...
                <div class="desc__wrap flex">
                    <div class="thumb">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_thumb04.png" alt="サムネイル">
                    </div>
                ...
                <div class="desc__img">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/retouch_img01.jpg?1458" alt="バナーサンプル">
                </div>
...
<?php else: ?>
 <div class="desc__contents__wrap left">
             ...
             <div class="desc__img">
                 <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/retouch_img01.jpg?1458" alt="バナーサンプル">
                 <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_img_sub01.png" alt="ポイント" class="sub__img">
             </div>
...
<?php endif; ?>
   ...
   <div class="desc__contents">
                ...
                <div class="desc__wrap flex">
                    <div class="thumb">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_thumb05.png" alt="サムネイル">
                    </div>
                 ...
                 <div class="desc__wrap flex">
                    <div class="thumb">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_thumb06.png" alt="サムネイル">
                    </div>
                 ...
                 <div class="desc__wrap flex">
                    <div class="thumb">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_thumb07.png" alt="サムネイル">
                    </div>
                ...
                <div class="desc__wrap flex">
                    <div class="thumb">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_thumb08.png" alt="サムネイル">
                    </div>
                ...
                <div class="desc__img">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/retouch_img02.jpg?1450" alt="バナーサンプル">
                </div>
...
<?php else: ?>
    <div class="desc__contents__wrap left">
             ...
             <div class="desc__img">
                 <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/retouch_img02.jpg?1458" alt="バナーサンプル">
                 <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/retouch/ retouch_img_sub02.png" alt="ポイント" class="sub__img">
             </div>
